...
It carries the **bar** (what counts as a finding here), the **walls**, **your one slice**, and **the
scratch directory you may write in**. Work to the bar as written — apply it, and do not widen it.
