...
Read `templates/report-investigate-template.md`, fill every `<fill:…>` slot, and hand the whole
body to `file_phase_report`. It owns the path and refuses a report with an unfilled slot left in it —
